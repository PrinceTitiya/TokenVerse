      ...
      {({ account, chain, openAccountModal, openChainModal, openConnectModal, mounted }) => {
        ...
        if (chain.unsupported) {
          return (
            <button
              ...
              className="group flex items-center gap-3 rounded-full border border-red-500/30 bg-red-500/10 py-2.5 pl-6 pr-2.5 text-base font-semibold text-red-400 transition-all duration-200 hover:bg-red-500/20"
            >
              Wrong Network
        ...
        return (
          <div className="flex items-center gap-3">
            <button
              onClick={openChainModal}
              className="flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-gray-300 transition-colors hover:bg-white/10"
            >
            ...
            <button
              ...
              className="group flex items-center gap-3 rounded-full bg-white py-2.5 pl-5 pr-2.5 text-base font-semibold text-gray-900 transition-all duration-200 hover:bg-gray-100"
            >
              {account.displayName}
              <span className="flex h-8 w-8 items-center justify-center rounded-full bg-amber-400 transition-transform duration-200 group-hover:scale-110">
                <svg width="14" height="14" viewBox="0 0 12 12" fill="none">
    ...
    <nav className="fixed left-0 right-0 top-0 z-50 border-b border-white/5 bg-gray-950/95 backdrop-blur-md">
      ...
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-8">
        ...
        <NavLink to="/" className="flex select-none items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-amber-400 to-purple-500 shadow-lg shadow-amber-500/20">
            <span className="text-base font-black text-gray-950">TV</span>
          </div>
