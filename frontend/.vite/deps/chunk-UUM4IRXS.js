...
var ICONS = {
  add: async () => (await import("./add-H6RVFKQK.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-6PFJYEGE.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-5QSQUQRX.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-NEU4S765.js")).appStoreSvg,
  apple: async () => (await import("./apple-HTJUWRB7.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-IJG6EZZE.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-DHGSBQWZ.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-INM2H53U.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-X4HYHZP7.js")).arrowTopSvg,
  bank: async () => (await import("./bank-7TRXZAGV.js")).bankSvg,
  browser: async () => (await import("./browser-NNDAERSM.js")).browserSvg,
  card: async () => (await import("./card-Z6F3HX3Z.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-O36AFHXZ.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-YTMD4IO4.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-5E7ZLXLP.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-IFHI33JX.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-EZQEHCOD.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-H6FI7XNO.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-RHLWKNCJ.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-ALIUMHH6.js")).clockSvg,
  close: async () => (await import("./close-PZVTH4DI.js")).closeSvg,
  compass: async () => (await import("./compass-E33KER3T.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-ML2P7IHO.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-CVDVAICE.js")).copySvg,
  cursor: async () => (await import("./cursor-LFUOMT7A.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-S6KGAPXA.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-MDWOHSCD.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-5GO655R6.js")).disconnectSvg,
  discord: async () => (await import("./discord-DSOJJTBU.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-4YZBBNJB.js")).etherscanSvg,
  extension: async () => (await import("./extension-ZO5KBCNR.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-KDIUX3EI.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-HNXXWYTT.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-JKPYJDJJ.js")).farcasterSvg,
  filters: async () => (await import("./filters-JRMVLRHZ.js")).filtersSvg,
  github: async () => (await import("./github-SYIEQ3LC.js")).githubSvg,
  google: async () => (await import("./google-ZMPQAXHE.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-X4TGK24F.js")).helpCircleSvg,
  image: async () => (await import("./image-QPBA5EZM.js")).imageSvg,
  id: async () => (await import("./id-RRBBCXWI.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-WVQTDLAL.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-EI7KLJKN.js")).lightbulbSvg,
  mail: async () => (await import("./mail-7R7WSNAV.js")).mailSvg,
  mobile: async () => (await import("./mobile-2M4SMLHI.js")).mobileSvg,
  more: async () => (await import("./more-ZPLX2IBS.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-MTCIVLCC.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-ZM2IYDVL.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-GOHMZKD3.js")).offSvg,
  playStore: async () => (await import("./play-store-UK367HX6.js")).playStoreSvg,
  plus: async () => (await import("./plus-7L3C2Z5X.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-IAHWWQJW.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-K3B5RVYD.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-RH5E7DRT.js")).refreshSvg,
  search: async () => (await import("./search-5XORV4J4.js")).searchSvg,
  send: async () => (await import("./send-2RT4NZWV.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-PJEBZBR3.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-KZ2LJ64T.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-7SIJ6PBR.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-ETA5RUE7.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-7BF2YXBO.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-7GSMEFUQ.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-O5LXO4M5.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-E4WOLB6D.js")).twitchSvg,
  twitter: async () => (await import("./x-3BBD4ODD.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-GL26EKE7.js")).twitterIconSvg,
  verify: async () => (await import("./verify-F5OCQAQO.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-3R2EOA4T.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-LGLF3XMV.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-XIJLVG3C.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-XIJLVG3C.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-XIJLVG3C.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-IGBDYXRH.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-W5TLTBJU.js")).warningCircleSvg,
  x: async () => (await import("./x-3BBD4ODD.js")).xSvg,
  info: async () => (await import("./info-WQNT7ENM.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-MZYPMQYA.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-O5Q6MUPH.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UUM4IRXS.js.map
