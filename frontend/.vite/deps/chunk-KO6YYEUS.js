...
function verify(options) {
  ...
  return secp256r12.verify(signature, payload instanceof Uint8Array ? payload : fromHex(payload), toHex(publicKey).substring(2), { lowS: true, ...hash ? { prehash: true } : {} });
}
...
__export(WebAuthnP256_exports, {
  ...
  getAttestationObject: () => getAttestationObject2,
  getAuthenticatorData: () => getAuthenticatorData2,
  getClientDataJSON: () => getClientDataJSON2,
...
(function(decodeCursor2) {
  ...
  function getFloat16(bits) {
    ...
    if (exponent === 0) {
      ...
      return sign4 ? -value2 : value2;
    }
    if (exponent === 31) {
      if (fraction === 0)
        return sign4 ? -Infinity : Infinity;
      return NaN;
    }
    const value = 2 ** (exponent - 15) * (1 + fraction / 1024);
    return sign4 ? -value : value;
  }
...
var CreateFailedError = class extends BaseError {
  constructor({ cause } = {}) {
...
function verify2(options) {
  ...
  if (rpId !== void 0) {
    ...
    const expectedRpIdHash = sha2562(fromString2(rpId), { as: "Bytes" });
  ...
  if (clientData.type !== "webauthn.get")
    return false;
  if (!clientData.challenge || fromBytes(toBytes3(clientData.challenge)) !== challenge)
    return false;
  if (origin !== void 0) {
...
// node_modules/ox/_esm/core/WebAuthnP256.js
var createChallenge2 = createChallenge;
async function createCredential(options) {
  return create2(options);
}
var getAuthenticatorData2 = getAuthenticatorData;
var getClientDataJSON2 = getClientDataJSON;
var getAttestationObject2 = getAttestationObject;
var getCredentialCreationOptions = getOptions;
var getCredentialRequestOptions = getOptions2;
var getSignPayload2 = getSignPayload;
async function sign3(options) {
  return sign2(options);
}
...
@noble/curves/esm/p256.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-KO6YYEUS.js.map
