...
function decode2(...parameters) {
  ...
  if (((_a = abiConstructor.inputs) == null ? void 0 : _a.length) === 0)
    return void 0;
...
function decodeData(...parameters) {
  ...
  if (((_a = abiFunction.inputs) == null ? void 0 : _a.length) === 0)
    return void 0;
...
async function simulateCalls(client, parameters) {
  ...
  const getBalanceData = account ? encode2(from2("constructor(bytes, bytes)"), {
    ...
    args: [
      getBalanceCode,
      encodeData(from3("function getBalance(address)"), [account.address])
    ]
  }) : void 0;
...
//# sourceMappingURL=chunk-I3JCFDG6.js.map
