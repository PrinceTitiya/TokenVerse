...
function fromPacked(packed) {
  ...
  const { factory, factoryData } = (() => {
    ...
    const factoryData2 = size2(initCode) > 20 ? slice(initCode, 20) : void 0;
  ...
  const { paymaster, paymasterVerificationGasLimit, paymasterPostOpGasLimit, paymasterData } = (() => {
    ...
    const paymasterData2 = size2(paymasterAndData) > 52 ? slice(paymasterAndData, 52) : void 0;
    return {
...
function toRpc4(userOperationGas) {
  const rpc = {};
...
//# sourceMappingURL=chunk-Y3VZVSDS.js.map
